...
export default function ProductList() {
  ...
  const handlePage = (page) => {
    //change the page based on requirement in backend
    setPage(page*10);
  };
...
<MobileFilter mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleFilter={handleFilter} filters={filters}/>
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
              <PaginationComponent page={page} setPage={setPage}handlePage={handlePage} totalItems={totalItems}/>
            </div>
          </main>
        </div>
      </div>
...
function PaginationComponent({page, setPage, handlePage, totalItems}) {
  return (
    <>
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                  ...
                  >
                    ...
                    {Array.from({length: Math.ceil(totalItems/ITEMS_PER_PAGE)}).map((pg, ind) => 
                    <div key={ind+pg}
                    onClick={(e)=> handlePage(ind+1)}
                    aria-current="page"
                    className={`relative z-10 inline-flex items-center ${ind+1===page/10? 'bg-indigo-600 text-white'  : 'bg-white-50 text-black'} px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer`}
                  >
                    {ind+1}
                  </div>
                  )}
